    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-sky-50 via-white to-cyan-50 p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-xl border-0">
          ...
          <CardContent className="space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg bg-white text-gray-700 font-medium hover:bg-gray-50 hover:shadow-md transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          Dental Lab Mate Pro v1.0.0 • Secure Google Authentication
        </p>
      </div>
    </div>
  );
