...
// Define interfaces for type safety and to satisfy ESLint
...
export async function GET() {
  try {
    ...
    const [
      ...
      // 10. Monthly volumes (Parallelized)
      Promise.all(
      ...
      // 11. Tech workload stats (Optimized)
      prisma.case.groupBy({
    ...
    // Post-process Turnaround and On-time Rate
    let avgTurnaround = 0;
    let onTimeRate = 0;
    ...
    techWorkloadStats.forEach((stat) => {
