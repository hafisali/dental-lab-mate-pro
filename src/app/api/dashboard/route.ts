...
export async function GET() {
  try {
    ...
    const [
      ...
      // Optimization: Fetch all payments for the last 6 months in one query to avoid N+1 pattern
    ...
    // Monthly revenue (last 6 months) - Aggregating in-memory for better performance
